...
func InitializeRoutes(e *gin.Engine) {
	...
	e.GET(env.PathValues.Datasources, security.AuthenticateAnyOrgOrSysAdmin(), handlers.GetAllHandler())
	e.GET(env.PathValues.InternalDatasources, security.AuthenticateApiKey(), handlers.GetAllInternalHandler())
